...
* Para arrancar el servidor de Zahorí y el Cluster de navegadores, ejecutamos desde la carpeta zahori-process/server:
+
----
...
* Para levantar el proceso en local ejecuta:
+
----
mvn spring-boot:run
----
...
* Para finalizar el servidor ejecutamos desde la carpeta zahori-process/server:
+
----
